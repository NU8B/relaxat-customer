...
export default function Page() {
  ...
  const handleSignIn = async (event: React.MouseEvent) => {
    ...
    if (true) {
      router.replace("/book"); // Use router.replace for client-side navigation
    } else {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 min-h-full flex flex-col justify-center p-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <h1 className="mt-2 text-center text-3xl font-bold uppercase text-gray-900">
            Relaxat
          </h1>
